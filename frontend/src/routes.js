...
export const Routes = {
    ...
    LandlordDashboard: { path: "/dashboard/landlord" },
    ...
    ListProperty: { path: "/property/list-property" },   
    
    PropertyListing: { path: "/property/property-listing" },   
    
    Users: { path: "/users/registration" },   
